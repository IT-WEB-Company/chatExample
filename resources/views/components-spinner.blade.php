...
@section('content')
    ...
    <div class="main-panel">
        ...
        <div class="main-content">
            <div class="content-wrapper"><!-- Start Of Bootstrap Spinners -->
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>You can customize the color with text color utilities. You can use any of our text color utilities on
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>Use Flexbox utilities to place spinners.Use <code>.d-flex</code> and <code>.align-items-{side}</code></p>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>Use <code>.spinner-border-{sm/lg} </code> and <code>.spinner-grow-{sm/lg}</code> for Small or Large
                                        spinner</p>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>Use <code>.spinner-border</code> or <code>.spinner-grow</code> inside buttons to indicate an action is
