        ...
        <div class="main-content">
            <div class="content-wrapper"><div class="row">
                    <div class="col-12">
                        ...
                        <p class="content-sub-header">All table styles are inherited in Bootstrap 4.1.3, meaning any nested tables will be
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>For basic styling add the base class <code>.table</code> to any <code>&lt;table&gt;</code>. It may seem
                                        super redundant, but given the widespread use of tables for other plugins like calendars and date pickers,
                                        we've opted to isolate our custom table styles.</p>
                                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>Use <code>.table-striped </code> and <code>.table-dark</code> to add zebra-striping to any table row and
                                        inverse styling within the <code>&lt;tbody&gt;</code>.</p>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <table class="table">
                                            ...
                                            <tr class="darken-4 bg-secondary">
                                                <th scope="row">Secondary</th>
                                                <td>Column content</td>
                                                <td>Column content</td>
                                                <td>Column content</td>
                                            </tr>
                                            <tr class="darken-4 bg-success">
                                                <th scope="row">Success</th>
                                                <td>Column content</td>
                                                <td>Column content</td>
                                                <td>Column content</td>
                                            </tr>
                                            <tr class="darken-4 bg-danger">
                                            ...
                                            <tr class="darken-4 bg-info">
                                                <th scope="row">Info</th>
                                                <td>Column content</td>
                                                <td>Column content</td>
                                                <td>Column content</td>
                                            </tr>
                                            <tr class="darken-4 bg-light text-dark">
                                                <th scope="row">Light</th>
                                                <td>Column content</td>
                                                <td>Column content</td>
                                                <td>Column content</td>
                                            </tr>
                                            <tr class="darken-4 bg-dark">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>Create responsive tables by adding <code>.table-responsive</code> to any <code>.table</code> to make them
                                        scroll horizontally on small devices (under 768px). When viewing on anything larger than 768px wide, you
                                        will not see any difference in these tables.</p>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
