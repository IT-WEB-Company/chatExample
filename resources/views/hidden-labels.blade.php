...
@section('content')
    <div class="main-panel">
        ...
        <div class="main-content">
            <div class="content-wrapper"><!-- Hidden label form layout section start -->
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">This is the most basic and default form having form sections. Just add <code>.sr-only</code>
                                        class to a label to hide. To add form section user <code>.form-section</code> class with any heading tags.
                                        This form has the buttons on the bottom left corner which is the default position.</p>
                                </div>
                                <div class="card-body">
                                    <div class="px-3">
                                        <form class="form">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">Just add <code>.sr-only</code> class to a label to hide. You can always change the border
                                        color of the form controls using <code>border-*</code> class. In this example we have user <code>border-primary</code>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">Just add <code>.sr-only</code> class to a label to hide. This form shows tooltips on hover to
                                        provide useful information while user is filling the form. Use data attributes like toggle <code>data-toggle</code>,
                                        trigger <code>data-trigger</code>, placement <code>data-placement</code>, title <code>data-title</code> to
                                        show tooltips on form controls.</p>
                                </div>
                                <div class="card-body">
                                    <div class="px-3">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">Just add <code>.sr-only</code> class to a label to hide. This form shows the use of icons
                                        with form controls. Define the position of the icon using <code>has-icon-left</code> or <code>has-icon-right</code>
                                        class. Use <code>icon-*</code> class to define the icon for the form control. See Icons sections for the
                                        list of icons you can use. </p>
                                </div>
                                <div class="card-body">
                                    <div class="px-3">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-12 mb-2">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" placeholder="Rate Per Hour" aria-label="Amount (to the nearest dollar)"
                                                                   name="rateperhour">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">Just add <code>.sr-only</code> class to a label to hide. This is a variation to the default
                                        form control styling. In this example all the form controls has round styling. To apply round style add
                                        class <code>round</code> to any form control.</p>
                                </div>
                                <div class="card-body">
                                    <div class="px-3">
                                        <form class="form">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">Just add <code>.sr-only</code> class to a label to hide. This is another variation to the
                                        default form control styling. In this example all the form controls has square styling. To apply square
                                        style add class <code>square</code> to any form control.</p>
                                </div>
                                <div class="card-body">
                                    <div class="px-3">
                                        <form class="form">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-12 mb-2">
                                                        ...
                                                        <input type="number" id="donationinput3" class="form-control square" name="contact" placeholder="contact number">
                                                    </div>
                                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>Just add <code>.sr-only</code> class to a label to hide. This example shows a way to center
                                        your form in the card. Here we have used <code>.justify-content-md-center .row</code> classes to center the
                                        form in a full width card. User can always change those classes according to width and offset requirements.
