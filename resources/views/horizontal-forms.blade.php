                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">Add <code>.form-horizontal</code> class to the form tag to have horizontal form styling. This
                                        horizontal form shows the use of icons with form controls. Define the position of the icon using <code>has-icon-left</code>
                                        or <code>has-icon-right</code> class. Use <code>icon-*</code> class to define the icon for the form
                                        control. See Icons sections for the list of icons you can use. </p>
                                </div>
                                <div class="card-content">
                                    <div class="px-3">
                                        <form class="form form-horizontal">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)" name="rateperhour">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>Add <code>.form-horizontal</code> class to the form tag to have horizontal form styling. This
                                        is horizontal form demo with centered card. Here we have used <code>.justify-content-md-center .row</code>
                                        classes to center the card as its not full width. User can always change column classes according to his
                                        requirements.</p>
                                </div>
                                <div class="card-content">
                                    <div class="px-3">
                                        <form class="form form-horizontal">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="number" id="eventRegInput5" class="form-control" name="contact">
                                                    </div>
                                                </div>
