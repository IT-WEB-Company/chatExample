                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <table class="table table-responsive-md text-center">
                                            ...
                                            <tbody>
                                            <tr>
                                                <td><img class="media-object round-media" src="app-assets/img/elements/01.png" alt="Generic placeholder image"
                                            ...
                                            <tr>
                                                <td><img class="media-object round-media" src="app-assets/img/elements/07.png" alt="Generic placeholder image"
                                                         style="height: 75px;" /></td>
                                                <td>Product 2</td>
                                                <td>15.9 Ounce</td>
                                                <td>$6.00</td>
                                            ...
                                            <tr>
                                                <td><img class="media-object round-media" src="app-assets/img/elements/11.png" alt="Generic placeholder image"
                                                         style="height: 75px;" /></td>
                                                <td>Product 3</td>
                                                <td>20.9 Ounce</td>
                                                <td>$15.78</td>
                                            ...
                                            <tr>
                                                <td><img class="media-object round-media" src="app-assets/img/elements/14.png" alt="Generic placeholder image"
                                                         style="height: 75px;" /></td>
                                                <td>Product 4</td>
                                                <td>90 Ounce</td>
                                                <td>$24.51</td>
