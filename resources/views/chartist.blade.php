    ...
    <div class="main-panel">
        ...
        <div class="main-content">
            <div class="content-wrapper"><!--Line with Area Chart 1 Starts-->
                <div class="row">
                    <div class="col-sm-12">
                        <div class="content-header">Chartist</div>
                        <p class="content-sub-header">Angular component for Chartist.js</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Line with Area Chart</h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <div id="line-area1" class="height-400 lineArea1">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div id="line-area3" class="height-400 lineArea3">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div id="line-chart1" class="height-400 lineChart1 lineChart1Shadow">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div id="scatter-line-chart" class="height-400">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div id="scatter-chart2" class="height-400">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div id="bi-polar-chart" class="height-400">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div id="bar-chart" class="height-400">
                                    </div>
                                </div>
                            </div>
                        </div>
