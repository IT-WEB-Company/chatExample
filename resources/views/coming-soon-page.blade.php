...
<head>
    ...
    <title>Coming Soon Page - Apex responsive bootstrap 4 admin template</title>
...
<script src="app-assets/vendors/js/jquery.countdown.min.js" type="text/javascript"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN APEX JS-->
...
<!-- END APEX JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="app-assets/js/coming-soon.js" type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->
</body>
<!-- END : Body-->
</html>
