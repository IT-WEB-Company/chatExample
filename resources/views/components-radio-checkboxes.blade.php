...
@section('content')
    ...
    <div class="main-panel">
        ...
        <div class="main-content">
            <div class="content-wrapper"><!-- Start of Bootstrap Radios -->

                <section id="bootstrap-radio">
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Custom Radios</h4>
                                    <p>Use class <code>.custom-radio</code> for Custom Radios</p>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label" for="customRadio2">Disabled radio</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>Use class <code>.custom-control-inline</code> for Inline Radios</p>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="custom-radio custom-control-inline ml-3">
                                            <input type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input"
                                                   disabled>
                                            <label class="custom-control-label" for="customRadioInline2">Disabled Inline radio</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- End of Bootstrap Radios -->

                <!-- Start Of Bootstrap Checkboxes  -->

                <section id="bootstrap-checkboxes">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="content-header">Checkboxes</div>
                        </div>
                    </div>
                    ...
                    <div class="row match-height">
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>Use class <code>.custom-checkbox</code> for Custom Checkbox</p>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="customCheck1">You can't check this disabled checkbox</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Inline Checkbox</h4>
                                    <p>Use class <code>.custom-control-inline</code> for Inline Checkbox</p>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="custom-checkbox custom-control-inline ml-3">
                                            <input type="checkbox" id="customCheckboxInline2" name="customCheckboxInline1" class="custom-control-input"
                                                   disabled>
                                            <label class="custom-control-label" for="customCheckboxInline2">Disabled Inline Checkbox</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section id="bootstrap-switch">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="content-header">Switches</div>
                        </div>
                    </div>
