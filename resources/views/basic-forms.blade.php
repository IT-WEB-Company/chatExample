                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">You can always change the border color of the form controls using <code>border-*</code>
                                        class. In this example we have user <code>border-primary</code> class for form controls. Form action
                                        ...
                                        <form class="form">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control border-primary" id="userinput7" number>
                                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">This form shows tooltips on hover to provide useful information while user is filling the
                                        form. Use data attributes like toggle <code>data-toggle</code>, trigger <code>data-trigger</code>,
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">This form shows the use of icons with form controls. Define the position of the icon using
                                        <code>has-icon-left</code> or <code>has-icon-right</code> class. Use <code>icon-*</code> class to define
                                        the icon for the form control. See Icons sections for the list of icons you can use. </p>
                                </div>
                                <div class="card-content">
                                    <div class="px-3">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">This is a variation to the default form control styling. In this example all the form
                                        controls has round styling. To apply round style add class <code>round</code> to any form control.</p>
                                </div>
                                <div class="card-content">
                                    <div class="px-3">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">This is another variation to the default form control styling. In this example all the form
                                        controls has square styling. To apply square style add class <code>square</code> to any form control.</p>
                                </div>
                                <div class="card-content">
                                    <div class="px-3">
                                        ...
                                        <form class="form">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input number id="donationinput3" class="form-control square" name="contact">
                                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>This example shows a ways to center your card with form. Here we have used <code>.justify-content-md-center
                                            .row</code> classes to center the card as its not full width. User can always change column classes
                                        according to his requirements. This example also uses form action buttons in the center bottom position of
                                        the card.</p>
                                </div>
                                <div class="card-content">
                                        ...
                                        <form class="form">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input number id="eventRegInput5" class="form-control" name="contact">
                                                </div>
