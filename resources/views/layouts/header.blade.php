            ...
            <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
                <li class="has-sub nav-item"><a href="#"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">2</span></a>
                    <ul class="menu-content">
                        <li><a href="dashboard-1" class="menu-item">Dashboard1</a>
                        </li>
                        <li><a href="dashboard-2" class="menu-item">Dashboard2</a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="color-palette"><i class="ft-droplet"></i><span data-i18n="" class="menu-title">Color Palette</span></a>
                </li>
                <li class=" nav-item"><a href="inbox.html"><i class="ft-mail"></i><span data-i18n="" class="menu-title">Inbox</span></a>
                </li>
                <li class="active"><a href="chat"><i class="ft-message-square"></i><span data-i18n="" class="menu-title">Chat</span></a>
                </li>
                <li class=" nav-item"><a href="taskboard"><i class="ft-file-text"></i><span data-i18n="" class="menu-title">Task Board</span></a>
                </li>
                <li class=" nav-item"><a href="calendar"><i class="ft-calendar"></i><span data-i18n="" class="menu-title">Calendar</span></a>
                </li>
                <li class="has-sub nav-item"><a href="#"><i class="ft-aperture"></i><span data-i18n="" class="menu-title">UI Kit</span></a>
                    <ul class="menu-content">
                        <li><a href="grids" class="menu-item">Grid</a>
                        </li>
                        <li><a href="typography" class="menu-item">Typography</a>
                        </li>
                        <li><a href="syntax-highlighter" class="menu-item">Syntax Highlighter</a>
                        </li>
                        <li><a href="helper-classes" class="menu-item">Helper Classes</a>
                        </li>
                        <li><a href="text-utilities" class="menu-item">Text Utilities</a>
                        </li>
                        <li class="has-sub"><a href="#" class="menu-item">Icons</a>
                            <ul class="menu-content">
                                <li><a href="feather" class="menu-item">Feather Icon</a>
                                </li>
                                <li><a href="font-awesome" class="menu-item">Font Awesome Icon</a>
                                </li>
                                <li><a href="simple-line" class="menu-item">Simple Line Icon</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
