...
@section('content')
    <div class="main-panel">
        ...
        <div class="main-content">
            <div class="content-wrapper"><!-- // Basic example section Starts -->
                <section id="basic-examples">
                    <div class="row">
                        <div class="col-sm-12 mt-3 mb-1">
                            <div class="content-header">SweetAlert</div>
                            <p class="content-sub-header">SweetAlert automatically centers itself on the page and looks great no matter if
                                you're using a desktop computer, mobile or tablet. It's even highly customizable, as you can see below!</p>
                        </div>
                    </div>
                    <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row mt-1">
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <button type="button" class="btn btn-primary btn-raised btn-block" id="basic-alert">Basic</button>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <button type="button" class="btn btn-primary btn-raised btn-block" id="with-title">With Title</button>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <button type="button" class="btn btn-primary btn-raised btn-block" id="html-alert">HTML</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section id="types">
                    <div class="row">
                        <div class="col-12 mt-3 mb-1">
                            ...
                            <p class="content-sub-header">The type of the modal. SweetAlert comes with 5 built-in types which will show a
                                corresponding icon animation: "warning", "error", "success" "info" and "question". You can also set it as
                                "input" to get a prompt modal. It can either be put in the object under the key "type" or passed as the third
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row mt-1">
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <button type="button" class="btn btn-secondary btn-raised btn-block mb-5" id="type-question">Question</button>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <button type="button" class="btn btn-success btn-raised btn-block mb-5" id="type-success">Success</button>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <button type="button" class="btn btn-info btn-raised btn-block mb-5" id="type-info">Info</button>
                                    </div>
                                    <div class="col-sm-6 col-12">
                                        <button type="button" class="btn btn-warning btn-raised btn-block mb-5" id="type-warning">Warning</button>
                                    </div>
                                    <div class="col-sm-6 col-12">
                            ...
                            <div class="card-body">
                                <div class="row mt-1">
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        ...
                                        <p><code>imageUrl</code> is used to add a customized icon for the modal. Should contain a string with the
                                            path to the image.</p>
                                        <button type="button" class="btn btn-primary btn-raised btn-block" id="custom-icon">Custom Icon</button>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <h5 class="mt-4">Auto Close Timer</h5>
                                        <p>A message with auto close timer. <code>timer</code> is default set to <code>null</code>. You can set
                                            timer in ms (milliseconds).</p>
                                        <button type="button" class="btn btn-primary btn-raised btn-block" id="auto-close">Auto Close</button>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <h5 class="mt-4">Allow Outside Click</h5>
                                        <p>If <code>allowOutsideClick</code> is set to <code>true</code>, the user can dismiss the modal by
                                            clicking outside it.</p>
                                        <button type="button" class="btn btn-primary btn-raised btn-block" id="outside-click">Click Outside</button>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <h5 class="mt-4">Ajax Request</h5>
                                        <p>Set <code>showLoaderOnConfirm</code> to true to disable the buttons and show that something is loading.
                                            AJAX request for example.</p>
                                        <button type="button" class="btn btn-primary btn-raised btn-block" id="ajax-request">Ajax</button>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <h5 class="mt-4">Button Options</h5>
                                        <p>Custom HTML description and buttons</p>
                                        <button type="button" class="btn btn-primary btn-raised btn-block" id="custom-button">Custom HTML and
                                            buttons</button>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        ...
                                        <button type="button" class="btn btn-primary btn-raised btn-block" id="prompt-function">Prompt</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        ...
                                        <button type="button" class="btn btn-primary btn-raised btn-block" id="confirm-text">Confirm Text</button>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <h5 class="mt-4">Confirm &amp; Cancel Button</h5>
                                        <p>Confirm and cancel button excecution options.</p>
                                        <button type="button" class="btn btn-primary btn-raised btn-block" id="confirm-cancel">Buttons Actions</button>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <h5 class="mt-4">Chaining modals</h5>
                                        <p>Changing modal on next button.</p>
                                        <button type="button" class="btn btn-primary btn-raised btn-block" id="steps">Steps</button>
                                    </div>
                                </div>
                            </div>
                        </div>
