                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">Add <code>.striped-rows</code> to form tag to add striped rows. In this example <code>.form-horizontal</code>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">Add <code>.striped-rows</code> to form tag to add striped rows. In this example icons are
                                        used with form controls to show the striped rows functionality.</p>
                                </div>
                                <div class="card-body">
                                    <div class="px-3">
                                        <form class="form form-horizontal striped-rows form-bordered">
                                        ...
                                        <form class="form form-horizontal striped-rows">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input number id="eventRegInput5" class="form-control" name="contact" placeholder="contact number">
                                                    </div>
                                                </div>
