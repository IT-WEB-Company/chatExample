    ...
    <div class="main-panel">
        ...
        <div class="main-content">
            <div class="content-wrapper"><div class="row">
                    <div class="col-sm-12">
                        <div class="content-header">Text Utilities</div>
                    </div>
                </div>
                <!-- Contextual colors -->
                ...
                <section id="contextual-background" class="card">
                    <div class="card-header">
                        ...
                        <p>Contextual text color classes, easily set the background of an element to any contextual class. Anchor components will darken on hover, just like the text classes.</p>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <div class="table-responsive">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table mb-0 table-responsive">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-justify">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                ...
                <section id="text-option" class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="card-text">
                                <h5 class="text-bold-600 mb-1">Font size</h5>
                                <p>Apex Admin provide font large & small sizes variant classes to change font size.</p>
                            </div>
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    <thead>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="font-large-3">Large text size.</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="font-large-2">Large text size.</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="font-large-1">Large text size.</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="font-medium-3">Medium text size.</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="font-medium-2">Medium text size.</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="font-medium-1">Medium text size.</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="font-small-3">Small text size.</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="font-small-2">Small text size.</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="font-small-1">Small text size.</p>
                                        </td>
                                        <td>
                            ...
                            <div class="card-text">
                                <h5 class="text-bold-600 my-1">Font weight</h5>
                                <p>Apex Admin provide font weight class <code>.text-bold-&#123;weight&#125;</code>, where <code>&#123;weight&#125; value can be 100,200 ... 900.</code></p>
                            </div>
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    <thead>
                            ...
                            <div class="card-text">
                                <h4 class="text-bold-600 my-1">Inline text elements</h4>
                                <p>Styling for common inline HTML5 elements.</p>
                                <p><code class="highlighter-rouge">.mark</code> and <code class="highlighter-rouge">.small</code> classes are
                                    also available to apply the same styles as <code class="highlighter-rouge">&lt;mark&gt;</code> and
                                    <code
                                        class="highlighter-rouge">&lt;small&gt;</code> while avoiding any unwanted semantic implications that the tags would bring.</p>
                                <p class="">While not shown above, feel free to use <code class="highlighter-rouge">&lt;b&gt;</code> and <code class="highlighter-rouge">&lt;i&gt;</code>                    in HTML5. <code class="highlighter-rouge">&lt;b&gt;</code> is meant to highlight words or phrases without
                                    conveying additional importance while <code class="highlighter-rouge">&lt;i&gt;</code> is mostly for
