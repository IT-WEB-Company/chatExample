...
@section('content')
    ...
    <div class="main-panel">
        ...
        <div class="main-content">
            <div class="content-wrapper"><!-- Base style table -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="card-text">The DataTables default style file has a number of features which can be enabled based
                                        on the class name of the table. These features are.</p>
                                </div>
                ...
                <section id="no-style">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">No styling classes</h4>
                                    <p class="card-text">This example shows the base DataTables style file being used, with none of the
                                        additional feature style classes being used.</p>
                                </div>
                                <div class="card-content ">
                                    <div class="card-body card-dashboard">
                                        <div class="table-responsive">
                                            <table class="no-style-no no-style">
                                                <thead>
                                                <tr>
                                                    <th>Name</th>
                                                    <th>Position</th>
                ...
                <section id="compact-style">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Base style - compact</h4>
                                    <p>The compact class is used to reduce the amount of white-space the default styling for the DataTable
                                        uses, increasing the information density on screen, as shown below.</p>
                                </div>
                                <div class="card-content ">
                                    <div class="card-body card-dashboard">
                                        <div class="table-responsive">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="card-text">DataTables can integrate seamlessly with Bootstrap 3 using Bootstrap's table styling
                                        options to present an interface with a uniform design, based on Bootstrap, for your site / app.
                                    </p>
                                </div>
                                <div class="card-content ">
                                    <div class="card-body card-dashboard">
