    ...
    <div class="main-panel">
        ...
        <div class="main-content">
            <div class="content-wrapper"><!-- Line Chart Starts -->
                <div class="row">
                    <div class="col-sm-12">
                        <div class="content-header">ChartJS</div>
                        <p class="content-sub-header">Chart.js can be used with ES6 modules, plain JavaScript and module loaders.</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body chartjs">
                                    <canvas id="scatter-logx" height="400"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
