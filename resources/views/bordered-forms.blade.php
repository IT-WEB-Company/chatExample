                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">Add <code>.form-bordered</code> to form tag to add border to a form-group. In this example
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">Add <code>.form-bordered</code> to form tag to add border to a form-group. In this example
                                        2-column <code>.form-horizontal</code> is used with primary color bordered form controls to show the
                                        bordered form functionality.</p>
                                </div>
                                <div class="card-body">
                                    <div class="px-3">
                                        <form class="form form-horizontal form-bordered">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row last">
                                                            ...
                                                            <div class="col-md-9">
                        <textarea id="userinput8" rows="6" class="form-control col-md-9 border-primary" name="bio"
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">Add <code>.form-bordered</code> to form tag to add striped rows. In this example icons are
                                        used with form controls to show the bordered form functionality.</p>
                                </div>
                                <div class="card-body">
                                    <div class="px-3">
