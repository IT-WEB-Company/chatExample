...
@section('content')
    ...
    <div class="main-panel">
        ...
        <div class="main-content">
            <div class="content-wrapper"><!-- Switchery Switch start -->
                <section class="switchery-toggle" id="switchery-toggle">
                    <div class="row">
                        <div class="col-12 mt-3 mb-1">
                            <h4 class="text-uppercase">Switch</h4>
                        </div>
                    </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="form-group ">
                                            ...
                                            <p class="text-muted"> To set Large Switchery toggle, add <code>data-size="lg"</code> to checkbox with
                                                <code>.switchery</code> class.</p>
                                        </div>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <p class="text-muted"> To set Small Switchery toggle, add <code>data-size="sm"</code> to checkbox with
                                                <code>.switchery</code> class.</p>
                                        </div>
                                        <div class="form-group mt-1">
                                            ...
                                            <p class="text-muted"> To set Extra Small Switchery toggle, add <code>data-size="xs"</code> to checkbox
